...
def get_models():
	models = dict()
	models['1'] = RandomForestClassifier(max_features=1,n_estimators=100)
	models['2'] = RandomForestClassifier(max_features=2,n_estimators=100)
	models['3'] = RandomForestClassifier(max_features=3,n_estimators=100)
	models['4'] = RandomForestClassifier(max_features=4,n_estimators=100)
	models['5'] = RandomForestClassifier(max_features=5,n_estimators=100)
	models['6'] = RandomForestClassifier(max_features=6,n_estimators=100)
	models['7'] = RandomForestClassifier(max_features=7,n_estimators=100)
	return models
