...
naiveBayes25=GaussianNB()
naiveBayes25.fit(x_train, y_train)
predictions25=naiveBayes25.predict(x_validation)
...
naiveBayes40=GaussianNB()
naiveBayes40.fit(x_train, y_train)
predictions40=naiveBayes40.predict(x_validation)
accuracyScore40=accuracy_score(y_validation,predictions40)*100
confusionMatrix40=confusion_matrix(y_validation,predictions40)
classificationReport40=classification_report(y_validation,predictions40)
